                ...
                <div class="flex justify-between items-center p-4 border-b">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Modify the details of the Product</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                <option value="" disabled <?php echo (!$product['discount_percentage']) ? 'selected' : ''; ?>>Select discount percentage</option>
                                <option value="10" <?php echo ($product['discount_percentage'] == 10) ? 'selected' : ''; ?>>10%</option>
                                <option value="15" <?php echo ($product['discount_percentage'] == 15) ? 'selected' : ''; ?>>15%</option>
                                <option value="20" <?php echo ($product['discount_percentage'] == 20) ? 'selected' : ''; ?>>20%</option>
                                <option value="25" <?php echo ($product['discount_percentage'] == 25) ? 'selected' : ''; ?>>25%</option>
                                <option value="30" <?php echo ($product['discount_percentage'] == 30) ? 'selected' : ''; ?>>30%</option>
                                <option value="50" <?php echo ($product['discount_percentage'] == 50) ? 'selected' : ''; ?>>50%</option>
                                <option value="70" <?php echo ($product['discount_percentage'] == 70) ? 'selected' : ''; ?>>70%</option>
                                <option value="0" <?php echo ($product['discount_percentage'] == 0) ? 'selected' : ''; ?>>0%</option>
                            </select>
                        </div>
                        ...
                        <div id="variant-container">
                            <?php if (!empty($variants)): ?> <!-- Ensure variants exist -->
                                <?php foreach ($variants as $variant): ?>
                                    <div class="variant-group mb-4">
                                        ...
                                        <input
                                            ...
                                            value="<?php echo $variant['variant_name']; ?>"
                                            required>
                                    </div>
                                    ...
                                    <div class="variant-group mb-4">
                                        ...
                                        <input
                                            ...
                                            value="<?php echo $variant['image']; ?>"> <!-- Use array syntax for 'image' -->
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <p>No variants available for this product.</p> <!-- Message if no variants -->
                            <?php endif; ?>
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-3 py-2 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-gray-200">
                                <option value="" disabled <?php echo (!$product['sale_label']) ? 'selected' : ''; ?>>Select Sale Label</option>
                        ...
                        <div id="sale-end-date" style="display: <?php echo ($product['sale_label'] == 'Sale') ? 'block' : 'none'; ?>;">
