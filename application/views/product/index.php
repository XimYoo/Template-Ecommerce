        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <!--Breadcrumbs-->
                    <div class="breadcrumbs"><a href="index.html" title="Back to the home page">Home</a><span class="main-title fw-bold"><i class="icon anm anm-angle-right-l"></i>Product Standard</span></div>
                    <!--End Breadcrumbs-->
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                    ...
                    <div class="product-single-meta">
                        <h2 class="product-main-title">Product Standard</h2>
                        <!-- Product Reviews -->
                        ...
                        <div class="product-info">
                            <p class="product-vendor">Vendor:<span class="text"><a href="#">Spax</a></span></p>
                            <p class="product-type">Product Type:<span class="text">Shirts</span></p>
                            <p class="product-sku">SKU:<span class="text">RF104963</span></p>
            ...
            <div class="product-slider-4items gp10 arwOut5 grid-products">
                <div class="item col-item">
                    <div class="product-box">
                        ...
                        <div class="product-details text-left">
                            <!--Product Vendor-->
                            <div class="product-vendor">Sparx</div>
                            <!--End Product Vendor-->
                            <!-- Product Name -->
                ...
                <div class="item col-item">
                    <div class="product-box">
                        ...
                        <div class="product-details text-left">
                            <!--Product Vendor-->
                            <div class="product-vendor">Levis</div>
                            <!--End Product Vendor-->
                            <!-- Product Name -->
                            <div class="product-name">
                ...
                <div class="item col-item">
                    <div class="product-box">
                        ...
                        <div class="product-details text-left">
                            <!--Product Vendor-->
                            <div class="product-vendor">Wrang</div>
                            <!--End Product Vendor-->
                            <!-- Product Name -->
                            <div class="product-name">
                ...
                <div class="item col-item">
                    <div class="product-box">
                        ...
                        <div class="product-details text-left">
                            <!--Product Vendor-->
                            <div class="product-vendor">Husin</div>
                            <!--End Product Vendor-->
                            <!-- Product Name -->
                            <div class="product-name">
